...
class SLN_Enum_CheckoutFields
{
    ...
    static function init(){
        ...
        self::$field_type = ['text'=> __('Text', 'salon-booking-system'),'textarea'=> __('Textarea', 'salon-booking-system'),'checkbox'=> __('Checkbox', 'salon-booking-system'),'select'=> __('Select', 'salon-booking-system'), 'html'=> __('Html', 'salon-booking-system')];
